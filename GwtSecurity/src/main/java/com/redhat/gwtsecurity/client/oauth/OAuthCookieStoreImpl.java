...
public class OAuthCookieStoreImpl extends OAuthTokenStoreImpl {
    ...
    var m = @com.redhat.gwtsecurity.client.oauth.OAuthCookieStoreImpl::ensureCookies();
    return m[@com.redhat.gwtsecurity.client.oauth.OAuthCookieStoreImpl::COOKIE_PREFIX + key];
  }-*/;

    @Override
    public native void clear() /*-{
    $doc.cookie = null;
    @com.redhat.gwtsecurity.client.oauth.OAuthCookieStoreImpl::cachedCookies = null;
  }-*/;
    ...
    @com.redhat.gwtsecurity.client.oauth.OAuthCookieStoreImpl::cachedCookies = {};
    ...
    if (docCookie && docCookie != '') {
      ...
      for ( var i = 0; i < crumbs.length; ++i) {
        ...
        @com.redhat.gwtsecurity.client.oauth.OAuthCookieStoreImpl::cachedCookies[name] = value;
      }
    }
  }-*/;
