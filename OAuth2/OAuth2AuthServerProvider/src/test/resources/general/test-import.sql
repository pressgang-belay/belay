insert into CLIENT (CLIENT_ID, CLIENT_IDENTIFIER, CLIENT_NAME, CLIENT_REDIRECT_URI, GRANTS_MUST_EXPIRE) values (-1, 'public_client_id', 'PublicClient', 'http://localhost:8080/publicclient', true)
insert into CLIENT (CLIENT_ID, CLIENT_IDENTIFIER, CLIENT_NAME, CLIENT_REDIRECT_URI, GRANTS_MUST_EXPIRE, CLIENT_SECRET) values (-2, 'confidential_client_id', 'ConfidentialClient', 'http://localhost:8080/confidentialclient', true, 'clientsecret')
