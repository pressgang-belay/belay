...
public class Constants {
    ...
    public static final String AUTHORIZING_IDENTITY_PRIMARY = "authorizingIdentityPrimary";
    public static final String SECOND_TOKEN = "second_token";
    public static final String SECOND_USER_PRIMARY = "second_user_primary";
    ...
    public static final String ORIGINAL_REQUEST_PARAMS = "oauth_request_params";
    ...
    public static final String ONE_MINUTE = "60"; // In seconds
