...
import static org.jboss.pressgangccms.oauth.gwt.client.oauth.Common.OAUTH_POPUP_NAME;
...
class AuthoriserImpl extends Authoriser {
    ...
    private native void register() /*-{
        ...
        $wnd.oauth2win.__doAuthLogin = $entry(function(queryString, hash) {
          self.@org.jboss.pressgangccms.oauth.gwt.client.oauth.Authoriser::finish(Ljava/lang/String;Ljava/lang/String;)(queryString,hash);
        });
    }-*/;
