    ...
    */
    ...
    public static native void export() /*-{
        ...
        $wnd.oauth2win.authorise = $entry(function(req, success, failure) {
          @org.jboss.pressgangccms.oauth2.gwt.client.Authoriser::nativeLogin(*)(req, success, failure);
        });

        $wnd.oauth2win.expiresIn = $entry(function(req) {
          return @org.jboss.pressgangccms.oauth2.gwt.client.Authoriser::nativeExpiresIn(*)(req);
        });
    }-*/;
