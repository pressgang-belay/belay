...
public class OAuthCookieStoreImpl extends OAuthTokenStoreImpl {
    ...
    $doc.cookie = @org.jboss.pressgangccms.oauth2.gwt.client.OAuthCookieStoreImpl::COOKIE_PREFIX +
        encodeURIComponent(key) + '=' + encodeURIComponent(value);
  }-*/;

    @Override
    public native String get(String key) /*-{
    var m = @org.jboss.pressgangccms.oauth2.gwt.client.OAuthCookieStoreImpl::ensureCookies();
    return m[@org.jboss.pressgangccms.oauth2.gwt.client.OAuthCookieStoreImpl::COOKIE_PREFIX + key];
  }-*/;

    @Override
    public native void clear() /*-{
    $doc.cookie = null;
    @org.jboss.pressgangccms.oauth2.gwt.client.OAuthCookieStoreImpl::cachedCookies = null;
  }-*/;
    ...
    @org.jboss.pressgangccms.oauth2.gwt.client.OAuthCookieStoreImpl::cachedCookies = {};
    ...
    if (docCookie && docCookie != '') {
      ...
      for ( var i = 0; i < crumbs.length; ++i) {
        ...
        @org.jboss.pressgangccms.oauth2.gwt.client.OAuthCookieStoreImpl::cachedCookies[name] = value;
      }
    }
  }-*/;
