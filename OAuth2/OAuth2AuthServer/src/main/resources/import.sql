...
insert into CLIENT (CLIENT_ID, CLIENT_IDENTIFIER, CLIENT_NAME, CLIENT_REDIRECT_URI) values (-1, 'OAuth2AuthServer', 'OAuth2AuthServer', '/auth/user/associate/completeAssociation')
