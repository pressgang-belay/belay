...
public class IdentityWebService {
    ...
    public Response associateUser(@Context HttpServletRequest request,
        ...
        try {
            ...
            return handleOAuthSystemException(log, e, oAuthRedirectUri, SC_INTERNAL_SERVER_ERROR, SYSTEM_ERROR);
        }
    }
    ...
    public Response completeAssociation(@Context HttpServletRequest request) throws OAuthProblemException,
        ...
        String secondId = getStringAttributeFromSessionAndRemove(request, log, OPENID_IDENTIFIER, "Second identifier");
        log.info("Identifier to associate: " + secondId);
        String oAuthRedirectUri = getStringAttributeFromSessionAndRemove(request, log, STORED_OAUTH_REDIRECT_URI,
        ...
        if (!clientFound.isPresent()) {
            throw createOAuthProblemException(INVALID_CLIENT_APPLICATION, oAuthRedirectUri);
        }
        ...
        if (firstUser.equals(secondUser)) {
            throw createOAuthProblemException(IDENTITIES_ASSOCIATED_ERROR, oAuthRedirectUri);
        }
    ...
    private Response createTokenGrantResponseForIdentity(String oAuthRedirectUri, ClientApplication client,
        ...
        try {
            ...
            return handleOAuthSystemException(log, e, oAuthRedirectUri, SC_INTERNAL_SERVER_ERROR,
                    SYSTEM_ERROR);
        }
    }
    ...
    private Set<Scope> getGrantScopes(TokenGrant requestTokenGrant, Boolean secondIdentityIsPrimary,
        ...
        if (secondIdentityIsPrimary) {
            if (scopesRequested != null) {
                return checkScopes(authService, scopesRequested, secondIdentity.getIdentityScopes(), redirectUri);
            } else {
