...
insert into CLIENT (CLIENT_ID, CLIENT_IDENTIFIER, CLIENT_NAME, CLIENT_REDIRECT_URI, CLIENT_SECRET) values (-1, 'OAuthProvider', 'OAuthProvider', '/auth/identity/associate', 'none')
