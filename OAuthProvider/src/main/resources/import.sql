...
insert into CLIENT (CLIENT_ID, CLIENT_IDENTIFIER, CLIENT_NAME, CLIENT_REDIRECT_URI, CLIENT_SECRET) values (0, 'affbf16ab449cfa1e16392f705f9460', 'GWT Skynet', 'https://localhost:8443/GwtOAuthClient/org.jboss.pressgangccms.oauth.gwt.App/oAuthWindow.html', 'none')
