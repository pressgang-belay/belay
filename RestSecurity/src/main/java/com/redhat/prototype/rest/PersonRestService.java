...
public class PersonRestService {
	...
	public Response createPerson(Person person) {
		...
		if (person != null && person.getId() != null) {
			...
			try {
				...
				log.warning("Exception raised while creating person: "
						+ e.getMessage());
				Map<String, String> responseObj = new HashMap<String, String>();
	...
	public Response createOrUpdatePersonWithId(Person person) {
		...
		if (person != null && person.getId() == null) {
			...
			try {
				...
				// Handle generic exceptions
				log.warning("Exception raised while updating person: "
						+ e.getMessage());
				Map<String, String> responseObj = new HashMap<String, String>();
				responseObj.put("error", e.getMessage());
				builder = Response.status(Response.Status.BAD_REQUEST).entity(
	...
	public Response deletePerson(@PathParam("id") long id) {
		...
		if (person == null) {
			...
			try {
				...
				log.warning("Exception raised while deleting person: "
						+ e.getMessage());
				Map<String, String> responseObj = new HashMap<String, String>();
				responseObj.put("error", "Could not delete person");
				builder = Response.status(Response.Status.BAD_REQUEST).entity(
						responseObj);
			}
		}
	 ...
	 *             If member with the same email or username already exists
	 */
